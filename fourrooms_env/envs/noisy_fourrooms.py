...
# from attn_toy.envs.fourrooms import Fourrooms as Fourrooms
from fourrooms_env.envs.fourrooms import FourroomsNorender as Fourrooms
...
class ImageInputWarpper(gym.Wrapper):
    ...
    def __init__(self, env, max_steps=100):
        ...
        # self.state_space_capacity = self.envs.state_space_capacity
        self.mean_obs = None
    ...
    def reset(self, state=-1):
        ...
        # self.num_steps = self.envs.num_steps
        obs = self.env.render(state)
